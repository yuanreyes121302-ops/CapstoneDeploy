                ...
                <div class="profile-content">
                    <div class="booking-details">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($booking->contract_status === \App\Models\Booking::CONTRACT_TERMINATED)
                                <span class="badge bg-danger status-badge">Terminated</span>
                    ...
                    <div class="action-buttons">
                        @if ($booking->contract_status === \App\Models\Booking::CONTRACT_TERMINATED)
                            <div id="contract{{ $booking->id }}" class="contract-details" style="display: block; margin-top: 1rem; padding: 1.5rem; background: #f8f9ff; border-radius: 10px; border: 1px solid #e1e8ed;">
                                <h5><i class="fas fa-file-contract"></i> Contract Details (Terminated)</h5>
                                <p>This contract was terminated on {{ $booking->terminated_at ? $booking->terminated_at->format('F j, Y g:i A') : 'N/A' }}.</p>
                                @if($booking->termination_reason)
                                    <p><strong>Reason:</strong> {{ $booking->termination_reason }}</p>
                                @endif
                            </div>
                        @elseif ($booking->status === 'confirmed')
